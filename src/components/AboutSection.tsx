          ...
          >
            ...
            <p className="font-body text-muted-foreground leading-relaxed mb-4">
              <strong className="text-foreground">
                Lara Embroidery Designs
              </strong>
              , established in 2024, is dedicated to delivering elegant
              embroidery and professional stitching services.
            </p>
            <p className="font-body text-muted-foreground leading-relaxed mb-4">
              Owned and managed by{" "}
              <strong className="text-foreground">Lalitha</strong>, we focus on
              creating customized designs that reflect beauty, tradition, and
              modern style.
            </p>
            <p className="font-body text-muted-foreground leading-relaxed mb-4">
              We use professional embroidery machines for intricate patterns and
              offer expert blouse cutting & stitching services for all types of
              dresses at affordable prices.
            </p>
            <p className="font-body text-muted-foreground leading-relaxed mb-8">
              Our goal is to provide high-quality craftsmanship and ensure
              customer satisfaction with every piece we create.
            </p>
